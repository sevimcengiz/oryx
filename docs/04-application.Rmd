...
Click the ```select .spar file``` button , open dataset folder under Oryx-MRSI repository in your drive. Choose an example dataset or select your own dataset (Please, follow the steps at here (link)).
